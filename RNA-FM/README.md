...
python launch/predict.py --config="pretrained/extract_embedding.yml" --data_path="./data/data_rna_rna_inter/mirna-snorna_train_fasta.fasta" --save_dir="./resuts/mirna-snorna_train" --save_frequency 1 --save_embeddings
